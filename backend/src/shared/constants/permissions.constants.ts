export enum WorkspacePermission {
  ...
  VIEW_CUSTOM_FIELDS = 'workspace:view_custom_fields',
  MANAGE_CUSTOM_FIELDS = 'workspace:manage_custom_fields',
  CREATE_CUSTOM_FIELDS = 'workspace:create_custom_fields',
  UPDATE_CUSTOM_FIELDS = 'workspace:update_custom_fields',
  DELETE_CUSTOM_FIELDS = 'workspace:delete_custom_fields',
  UPDATE_SENSITIVE_FIELDS = 'workspace:update_sensitive_fields',
  VIEW_SENSITIVE_FIELDS = 'workspace:view_sensitive_fields',
...
export const ROLE_PERMISSIONS: Record<MembershipRole, WorkspacePermission[]> = {
  [MembershipRole.ADMIN]: [
    ...
    WorkspacePermission.VIEW_CUSTOM_FIELDS,
